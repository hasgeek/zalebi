...
import com.hasgeek.zalebi.adapters.RoomsAdapter;
...
public class RoomFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_space_room, container, false);
        ...
        mRecyclerView = (RecyclerView) v.findViewById(R.id.fragment_space_room_recyclerview);
...
//            getBus().post(new APIErrorEvent(space_id));
    ...
    public void onSingleSpaceLoaded(SingleSpaceLoadedEvent event) {
        ...
        mAdapter = new RoomsAdapter(getActivity(), event.getRooms());
        mRecyclerView.setAdapter(mAdapter);
